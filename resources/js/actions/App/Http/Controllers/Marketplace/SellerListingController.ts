...
/**
* @see \App\Http\Controllers\Marketplace\SellerListingController::deleteGalleryImage
 * @see app/Http/Controllers/Marketplace/SellerListingController.php:604
 * @route '/marketplace/seller/{listing}/images/{photo}'
 */
export const deleteGalleryImage = (args: { listing: string | number, photo: string | number } | [listing: string | number, photo: string | number ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
 ...
 * @route '/marketplace/seller/{listing}/images/{photo}'
 */
deleteGalleryImage.url = (args: { listing: string | number, photo: string | number } | [listing: string | number, photo: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    listing: args[0],
                    photo: args[1],
 ...
 * @route '/marketplace/seller/{listing}/images/{photo}'
 */
deleteGalleryImage.delete = (args: { listing: string | number, photo: string | number } | [listing: string | number, photo: string | number ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: deleteGalleryImage.url(args, options),
    method: 'delete',
})
 ...
 * @route '/marketplace/seller/{listing}/images/{photo}'
 */
    const deleteGalleryImageForm = (args: { listing: string | number, photo: string | number } | [listing: string | number, photo: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/marketplace/seller/{listing}/images/{photo}'
 */
        deleteGalleryImageForm.delete = (args: { listing: string | number, photo: string | number } | [listing: string | number, photo: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: deleteGalleryImage.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'DELETE',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
...
/**
* @see \App\Http\Controllers\Marketplace\SellerListingController::addGalleryImages
 * @see app/Http/Controllers/Marketplace/SellerListingController.php:576
 * @route '/marketplace/seller/{listing}/images'
 */
export const addGalleryImages = (args: { listing: string | number } | [listing: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: addGalleryImages.url(args, options),
    method: 'post',
})

addGalleryImages.definition = {
    methods: ["post"],
 ...
 * @route '/marketplace/seller/{listing}/images'
 */
addGalleryImages.url = (args: { listing: string | number } | [listing: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { listing: args }
    }
    ...
    return addGalleryImages.definition.url
            .replace('{listing}', parsedArgs.listing.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/marketplace/seller/{listing}/images'
 */
addGalleryImages.post = (args: { listing: string | number } | [listing: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: addGalleryImages.url(args, options),
    method: 'post',
})
 ...
 * @route '/marketplace/seller/{listing}/images'
 */
    const addGalleryImagesForm = (args: { listing: string | number } | [listing: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: addGalleryImages.url(args, options),
        method: 'post',
    })
 ...
 * @route '/marketplace/seller/{listing}/images'
 */
        addGalleryImagesForm.post = (args: { listing: string | number } | [listing: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: addGalleryImages.url(args, options),
            method: 'post',
        })
    
    addGalleryImages.form = addGalleryImagesForm
/**
...
const SellerListingController = { create, index, store, edit, update, destroy, updateImage, removeSwine, deleteGalleryImage, addGalleryImages, requests, findBySwine }

export default SellerListingController