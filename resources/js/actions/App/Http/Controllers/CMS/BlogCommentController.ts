...
/**
* @see \App\Http\Controllers\CMS\BlogCommentController::update
 * @see app/Http/Controllers/CMS/BlogCommentController.php:51
 * @route '/cms/comments/{comment}'
 */
...
const BlogCommentController = { store, destroy, update }
